...
export class PublicRegistrationComponent {
  ...
  private validateConfirmPassword(control: AbstractControl) {
    ...
    const passwordControl = this.contactDetailsFormGroup?.get('Password');
    if (
      !val ||
      control.invalid ||
  ...
  private validateUsername(control: AbstractControl) {
    ...
    return this.publicRegistrationService.checkUsernameExists(val).pipe(
      map((res: any) => {
        if (res.data) {
          return { unique: true };
        }
  ...
  //     return null;
  //   }
  //   return this.publicRegistrationService.checkGSTNExists(val).pipe(
  //     map((res: any) => {
  //       if (res.data) {
  //         return { unique: true };
  //       }
  ...
  //     return null;
  //   }
  //   return this.publicRegistrationService.checkGSTNUsernameExists(val).pipe(
  //     map((res: any) => {
  //       if (res.data) {
  //         return { unique: true };
  //       }
  ...
  public register() {
    ...
    this.publicRegistrationService.register(value).subscribe((res: any) => {
      if (!res.isSuccess) {
